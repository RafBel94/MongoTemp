...
public class EditFrame extends JFrame {
	...
	private EditFrameController eFrameController;
	...
	public EditFrame(QueryFrameController qFrameController) {
		...
		eFrameController = new EditFrameController(this);
	}
	...
	private void setFields() {
		...
		if (selectedRow != -1) {
			...
			JOptionPane.showMessageDialog(EditFrame.this, "Debe seleccionar una fila de una consulta para poder editar",
	...
	public EditFrameController geteFrameController() {
		return eFrameController;
	}
